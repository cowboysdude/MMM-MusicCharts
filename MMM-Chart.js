...
Module.register("MMM-Chart", {
    ...
    getDom: function() {
        ...
        if (!this.loaded) {
            ...
            wrapper.innerHTML = "Calculating your requested chart ...<img src='modules/MMM-Chart/icons/eq.gif' width=28px; height=28px;>";
        ...
        if (keys.length > 0) {
            ...
            if ("http://" + chart.cover != 'http://undefined') {
                ...
                artistIcon.src = "modules/MMM-Chart/icons/note.jpg";
            }
